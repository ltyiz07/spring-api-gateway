package com.stradvision.gate.customfilters.factories;
...
@Component
public class BodyScrubResponseGatewayFilterFactory extends AbstractGatewayFilterFactory<BodyScrubResponseGatewayFilterFactory.Config> {

    private ModifyResponseBodyGatewayFilterFactory modifyResponseBodyFilterFactory;

    public BodyScrubResponseGatewayFilterFactory(ModifyResponseBodyGatewayFilterFactory modifyResponseBodyFilterFactory) {
        super(Config.class);
